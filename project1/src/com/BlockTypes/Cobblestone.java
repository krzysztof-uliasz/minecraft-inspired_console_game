...
public class Cobblestone extends Block implements Stackable {
    public static final String mapName = "\u001B[37m" + "cobble" + "\u001B[0m";
    public static final String inventoryName = "\u001B[37m" + "Cobblestone" + "\u001B[0m";
    private static final int HARDNESS = 16;
    private static final int MAX_QUANTITY = 64;
    private int quantity = 1;

    public Cobblestone() {
        super(mapName, inventoryName, 0, 0);
        designatedTool = "pickaxe";
    }
    public Cobblestone(int quantity) {
        super(mapName, inventoryName, 0, 0);
        this.quantity = quantity;
        designatedTool = "pickaxe";
    }

    public Cobblestone(int positionX, int positionY) {
        super(mapName, inventoryName, positionX, positionY);
        designatedTool = "pickaxe";
    }

    public Cobblestone(int positionX, int positionY, int quantity) {
        super(mapName, inventoryName, positionX, positionY);
        this.quantity = quantity;
        designatedTool = "pickaxe";
    }
